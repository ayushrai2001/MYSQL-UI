...
JLabel l2,l11;
String dd,tt;
	public msg1(JFrame ff,String s1,String s2)
	{
		dd=s1;
		tt=s2;
		f1=ff;
		...
		fr.setContentPane(new JLabel(new ImageIcon("images/laku1.png")));
		
		
		l2 = new JLabel(""+tt+" "+dd+" succesfully....");
		...
		{
		new msg1(new JFrame(),"deleted","table");
		}
}
