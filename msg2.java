...
JLabel l2,l11;
String cc;
	public msg2(JFrame ff,String tt)
	{
		cc=tt;
		f1=ff;
		...
		fr.setContentPane(new JLabel(new ImageIcon("images/laku2.png")));
		
		
		l2 = new JLabel(""+cc+" renamed succesfully....");
